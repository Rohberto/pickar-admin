...
import { useProcessedPayments } from "./hooks/useProcessedPayment";
import { formatNaira } from "./list";
import { formatDate } from "../overview/data-selectors";

const ProcessedPaymentList = () => {
  const { completedPayment } = useProcessedPayments();
...
export default ProcessedPaymentList;
